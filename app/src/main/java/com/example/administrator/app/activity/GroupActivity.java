...
public class GroupActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        if(groupid==0){}//此时出错，返回上一个界面
//        groupid=34259921;//此id应由上一级指定，此处为测试数据
        ...
        sendbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isImage) {
                    ...
                    message = JMessageClient.createGroupTextMessage(groupid, sendtext.getText().toString());
                ...
                {
                    try {
                        message = JMessageClient.createGroupImageMessage(groupid, imageFile);
                        adapter.addData(message);
                        adapter.notifyDataSetChanged();
                        JMessageClient.sendMessage(message);
                        message.setOnSendCompleteCallback(new BasicCallback() {
