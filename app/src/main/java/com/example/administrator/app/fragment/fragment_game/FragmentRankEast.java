...
public class FragmentRankEast extends Fragment {
    ...
    private ArrayList<Team> eastTeamArrayList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rank_east, container, false);
        initViews(view);
        return view;
    }
        ...
        OkGo.get(RankUrl).execute(new StringCallback() {
            ...
            public void onSuccess(String s, Call call, Response response) {
                ...
                try {
                    ...
                    rankAdapter.addData(eastTeamArrayList);
    ...
    private void sortData(){
        ...
        for (int i=0;i<size;i++){
            ...
            if (team.getTable_area().equals("east")){
                eastTeamArrayList.add(team);
            }
        }
    }
